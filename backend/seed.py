...
def seed_db():
    ...
    try:
        ...
        # 1b. Auth identities are no longer seeded here. Identity now comes
        # from real Supabase Auth signups; the first time one of these
        # emails signs in for real, POST /auth/sync-profile claims this
        # seeded row automatically (see main.py) instead of creating a
        # second, blank one. To demo as one of these students, sign up in
        # Supabase with the matching email.
